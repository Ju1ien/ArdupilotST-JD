...
static void arm_motors_check()
{
    ...
    if (ap.land_complete && (control_mode == LOITER || control_mode == ALT_HOLD || control_mode == POSHOLD || control_mode == AUTOTUNE || control_mode == CRUISE)) {
        allow_arming = true;
    }
...
static void auto_disarm_check()
{
    ...
    if(manual_flight_mode(control_mode) || (ap.land_complete && (control_mode == LOITER || control_mode == ALT_HOLD || control_mode == POSHOLD || control_mode == AUTOTUNE || control_mode == CRUISE))) {
